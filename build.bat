...
if !BUILD_CPP! == 1 (
	...
	-additionalHeaderFiles "!additional_header_files_custom_type!Parameter.h ParameterManager.h perftestThreadPriorities.h RTIDDSLoggerDevice.h MessagingIF.h RTIDDSImpl.h perftest_cpp.h qos_string.h CpuMonitor.h PerftestTransport.h"^
	-additionalSourceFiles "!additional_source_files_custom_type!Parameter.cxx ParameterManager.cxx perftestThreadPriorities.cxx RTIDDSLoggerDevice.cxx RTIDDSImpl.cxx CpuMonitor.cxx PerftestTransport.cxx" -additionalDefines "!ADDITIONAL_DEFINES!"^
