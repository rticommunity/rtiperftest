...
if !BUILD_CPP! == 1 (
	...
	-additionalHeaderFiles "!additional_header_files_custom_type!RTIRawTransportImpl.h Parameter.h ParameterManager.h perftestThreadPriorities.h RTIDDSLoggerDevice.h MessagingIF.h RTIDDSImpl.h perftest_cpp.h qos_string.h CpuMonitor.h PerftestTransport.h"^
	-additionalSourceFiles "!additional_source_files_custom_type!RTIRawTransportImpl.cxx Parameter.cxx ParameterManager.cxx perftestThreadPriorities.cxx RTIDDSLoggerDevice.cxx RTIDDSImpl.cxx CpuMonitor.cxx PerftestTransport.cxx" -additionalDefines "!ADDITIONAL_DEFINES!"^
...
if !BUILD_CPP03! == 1 (
	...
	-create typefiles -create makefiles -platform %architecture%^
	-additionalHeaderFiles "perftestThreadPriorities.h Parameter.h ParameterManager.h MessagingIF.h RTIDDSImpl.h perftest_cpp.h qos_string.h CpuMonitor.h PerftestTransport.h"^
	-additionalSourceFiles "perftestThreadPriorities.cxx Parameter.cxx ParameterManager.cxx RTIDDSImpl.cxx CpuMonitor.cxx PerftestTransport.cxx" -additionalDefines "!ADDITIONAL_DEFINES!"^
